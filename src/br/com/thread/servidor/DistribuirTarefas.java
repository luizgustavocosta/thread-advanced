			...
			while (entradaCliente.hasNextLine()) {
				...
				switch (comando) {
					...
					case "c2": {
				        ...
				        ComandoC2ChamarWS c2WS = new ComandoC2ChamarWS(saidaCliente);
				        ComandoC2AcessaBD c2Banco = new ComandoC2AcessaBD(saidaCliente);
				        ...
				        Callable<Void> juntaResultados = new JuntaResultadosWSBD(futureWS, futureBanco, saidaCliente);
